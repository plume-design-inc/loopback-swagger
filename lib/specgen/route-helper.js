...
var routeHelper = module.exports = {
  ...
  routeToPathEntry: function(route, classDef,
    ...
    if (route.http && route.http.tags) {
      tags = tags.concat(route.http.tags);
    }
    ...
    var entry = {
      ...
      operation: {
        ...
        deprecated: route.http && route.http.deprecated,
        security: route.http && route.http.security ? route.http.security : undefined,
        'x-plume-visibility': route.http && route.http.plumeVisibility ? route.http.plumeVisibility : undefined,
      },
    };
