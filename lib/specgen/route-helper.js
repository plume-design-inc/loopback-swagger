...
var routeHelper = module.exports = {
  ...
  routeToPathEntry: function(route, classDef,
    ...
    if (route.returns && route.returns[0] && route.returns[0].message) {
      responseMessages[statusCode].description = route.returns[0].message;
    }
    ...
    if (route.documented && route.documented.tags) {
      tags = tags.concat(route.documented.tags);
    }
    ...
    var entry = {
      ...
      operation: {
        ...
        description: typeConverter.convertText(route.notes) || typeConverter.convertText(route.description),
        ...
        deprecated: route.documented && route.documented.deprecated,
        security: route.documented && route.documented.security ?? route.documented.security : undefined,
        'x-plume-access': route.documented && route.documented.plumeAccess ?? route.documented.plumeAccess : undefined,
      },
    };

    if (Array.isArray(entry.operation.parameters) && entry.operation.parameters.find(itm => itm.in === 'formData')) {
